  ...
  return (
    <center>
        <form className=" bg-white w-1/2 mt-20 pl-3 pr-3 rounded"> 
            ...
            <input className=' bg-slate-200 inline-block text-xs text-black mt-2 w-full pt-2 pb-2 pl-2 box-border border-solid border-2'
            ...
            <input className='bg-slate-200 inline-block text-xs text-black w-full mt-2 pt-2 pb-2 pl-2 box-border border-solid border-2'
            ...
            <p className='flex justify-start text-black mt-2'>By creating an account you agree to our 
